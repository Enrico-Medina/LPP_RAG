...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title = "São Paulo - Brazil Travel RAG Assistant",
    page_icon = "✈️ 🇧🇷",
    layout = "wide"
)
...
with st.sidebar:
    ...
    max_iter = st.slider("Max Tools Calls",
                         ...
                         help = "Maximun number of database queries per question")
    ...
    - Curated travel guides and local blogs about São Paulo
    - User reviews and descriptions of restaurants, bars, and attractions
    - Neighborhood-level safety and transportation information
    - Semantic search with embeddings to match user preferences (budget, interests, time of day)
    - Conversation context to refine suggestions and build dynamic, multi-day itineraries
    """)

# -----------------------------------------------------------------------------
# Main App Header
# -----------------------------------------------------------------------------
st.title("São Paulo - Brazil Travel RAG Assistant ✈️ 🇧🇷")
st.markdown("""
            This AI-powered travel assistant helps people plan trips to São Paulo, Brazil by providing personalized recommendations for:

            - Food and local gastronomy (from street food to fine dining)
            - Tourist attractions, parks, and cultural sites
            - Nightlife, events, and neighborhood vibes
            - Safety tips tailored to different areas and times of day
            - Public transportation, ride-sharing, and walking routes
""")
...
with st.expander("💡 Example Questions"):
    examples = [
        "I’m visiting São Paulo for 4 days. Can you help me build an itinerary?",
     "What are the must-see attractions for first-time visitors?",
     "Recommend bars with a great view of the city.",
     "What’s the safest way to get back from Vila Olímpia late at night?",
     "Tell me about the best museums to visit in São Paulo.",
     "Can you recommend a good Italian spot for dinner tonight?"
    ]
